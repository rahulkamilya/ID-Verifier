...
- Check the [issue tracker](https://github.com/rahulkamilya/ID-Verifier/issues) for open issues that you can work on or create a new issue if you have a -specific contribution in mind.
